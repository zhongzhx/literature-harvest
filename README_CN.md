# 关键词文献自动抓取与下载 Skill 使用说明（中文）

## 1. 这是什么

这是一个可复用的本地文献抓取工具包，用来根据**任意关键词**自动搜索和下载研究文献。
...
这个 skill 不是只给 *Aspergillus* 用的。  
只要你把查询词换成别的主题，也可以直接使用。
...
你可以直接把整个 `keyword-research-harvest` 文件夹发给别人。  
对方只需要：
